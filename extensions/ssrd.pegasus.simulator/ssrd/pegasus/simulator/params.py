...
EXTENSION_NAME = "SSRD Pegasus Simulator"
WINDOW_TITLE = "SSRD Pegasus Simulator"
MENU_PATH = "Window/" + WINDOW_TITLE
DOC_LINK = "https://docs.omniverse.nvidia.com"
EXTENSION_OVERVIEW = "This extension shows how to incorporate drones into Isaac Sim using SSRD's Pegasus Simulator"
...
ASSET_PATH = ROOT + "/ssrd/pegasus/simulator/assets"
