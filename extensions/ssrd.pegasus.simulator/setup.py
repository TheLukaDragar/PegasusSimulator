...
setup(
    name="ssrd-pegasus-simulator",
    author="Luka Dragar",
    maintainer="Luka Dragar",
    maintainer_email="luka.dragar@ssrd.si",
    url="https://github.com/TheLukaDragar/PegasusSimulator/tree/main/extensions/pegasus.simulator",
    version="5.0.0",
    description="SSRD's extension providing the main framework interfaces for simulating aerial vehicles using PX4, Python or ROS 2 as a backend",
    ...
    packages=["ssrd.pegasus.simulator"],
